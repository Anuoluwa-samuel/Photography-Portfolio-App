...
export function brandIcon(brandName: string) {
  ...
  const svg = `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'><rect width='64' height='64' rx='14' fill='#0b0d0e'/><text x='50%' y='57%' dominant-baseline='middle' text-anchor='middle' font-family='Arial,sans-serif' font-weight='700' font-size='38' fill='#f5b82e'>${letter}</text></svg>`;
